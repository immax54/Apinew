...
http
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        var url, method, body, body_1, body_2, body_3, body_4, body_5, body_6, body_7, body_8, body, body_9, body_10, body_11, body_12, body_13, body, body, body_14, body, body_15, body_16, body, rolesRepository, TempcontrolRepository, created, i, dishes, i, dishes, i, dishes, i, dishes, created_1, i, category, i, role, i, user, i, prof;
        var _this = this;
        return __generator(this, function (_a) {
            ...
            if (url.toString() === "/tempControlPost" && method === "POST") {
                ...
                req
                    ...
                    return __generator(this, function (_a) {
                        (0, healthPost_1.healthPost)(body_1, AppDataSource, res, req);
                        return [2 /*return*/];
                    });
                }); });
            }
                ...
                req
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                GetData(body_2, res);
                                if (!(isJsonString(body_2) === true)) return [3 /*break*/, 2];
                                res.statusCode = 200;
                                res.setHeader("Content-Type", "application/json");
                                return [4 /*yield*/, (0, brackPost_1.brackPost)(body_2, AppDataSource, res).then(function (data) { return data; })];
                            case 1:
                                if ((_a.sent()) === true) {
                ...
                req
                    ...
                    return __generator(this, function (_a) {
                        GetData(body_3, res);
                        (0, userPost_1.userPost)(body_3, AppDataSource, res, req);
                        return [2 /*return*/];
                    });
                }); });
            }
                ...
                req
                    ...
                    .on("end", function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        (0, accountPost_1.accountPost)(body_4, AppDataSource, res, req);
                        return [2 /*return*/];
                    });
                }); });
            }
                ...
                req
                    ...
                    .on("end", function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        (0, categoryPost_1.categoryPost)(body_5, AppDataSource, res);
                        return [2 /*return*/];
                    });
                }); });
            }
                ...
                req
                    ...
                    .on("end", function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        (0, dishPost_1.dishPost)(body_6, AppDataSource, res);
                        return [2 /*return*/];
                    });
                }); });
            }
                ...
                req
                    ...
                    .on("end", function () {
                    (0, proffessionPost_1.proffessionPost)(body_7, AppDataSource, res);
                });
            }
                ...
                req
                    ...
                    .on("end", function () {
                    (0, professionUserPost_1.proffessionUserPost)(body_8, AppDataSource, res);
                });
            }
                ...
                req
                    ...
                    .on("end", function () {
                    (0, subjectPost_1.subjectPost)(body_9, AppDataSource, res);
                });
            }
                ...
                req
                    ...
                    .on("end", function () {
                    (0, placePost_1.placePost)(body_10, AppDataSource, res);
                });
            }
                ...
                req
                    ...
                    .on("end", function () {
                    (0, departmentPost_1.departmentPost)(body_11, AppDataSource, res);
                });
            }
                ...
                body = [];
                (0, userPost_1.userPost)(body, AppDataSource, res, req);
            }
                ...
                req
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                GetData(body_14, res);
                                if (!(isJsonString(body_14) === true)) return [3 /*break*/, 2];
                                resjson = JSON.parse(body_14);
                ...
                req
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                GetData(body_15, res);
                                if (!(isJsonString(body_15) === true)) return [3 /*break*/, 2];
                                resjson = JSON.parse(body_15);
                ...
                created = new Date();
                for (i = 0; i <= arrays_1.listdishesgarnire.length - 1; i++) {
                    dishes = new Dishes_1.Dishes();
                    dishes.dish = arrays_1.listdishesgarnire[i];
                    dishes.active = true;
                    dishes.Category = 1;
                    AppDataSource.manager.save(dishes);
                }
                for (i = 0; i <= arrays_1.listdishesnapit.length - 1; i++) {
                    dishes = new Dishes_1.Dishes();
                    dishes.dish = arrays_1.listdishesnapit[i];
                    dishes.active = true;
                    dishes.Category = 2;
                    AppDataSource.manager.save(dishes);
                }
                for (i = 0; i <= listdishespech.length - 1; i++) {
                    dishes = new Dishes_1.Dishes();
                ...
                for (i = 0; i <= arrays_1.listdishessalats.length - 1; i++) {
                    dishes = new Dishes_1.Dishes();
                    dishes.dish = arrays_1.listdishessalats[i];
                    dishes.active = true;
                    dishes.Category = 4;
                    AppDataSource.manager.save(dishes);
                }
                ...
                created_1 = new Date();
                for (i = 0; i <= arrays_1.listcategory.length - 1; i++) {
                ...
                for (i = 0; i <= arrays_1.listroles.length - 1; i++) {
                ...
                for (i = 0; i < arrays_1.listnames.length; i++) {
                ...
                for (i = 0; i <= arrays_1.listprof.length - 1; i++) {
                    prof = new Professions_1.Profession();
