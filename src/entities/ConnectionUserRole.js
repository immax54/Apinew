...
var ConnectionUserRole = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Roles_1.Roles; }, function (Roles) { return Roles.id; }),
        (0, typeorm_1.Column)('integer'),
        (0, typeorm_1.JoinColumn)({
            name: 'roleId'
        })
    ], ConnectionUserRole.prototype, "Roles");
    __decorate([
    ...
    ], ConnectionUserRole.prototype, "created");
